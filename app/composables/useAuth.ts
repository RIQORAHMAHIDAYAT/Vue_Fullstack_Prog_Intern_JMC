export function useAuth() {
  ...
  async function login(username: string, password: string, remember: boolean = false, recaptchaToken?: string, captchaToken?: string, captchaAnswer?: string) {
    const res = await post<any>("/auth/login", { username, password, remember, captchaToken, captchaAnswer })
