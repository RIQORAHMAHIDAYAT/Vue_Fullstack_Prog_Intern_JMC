...
const passwordErrors = computed(() => {
  ...
  if (/\s/.test(form.password)) errs.push("Tidak boleh ada spasi")
  if (!/[A-Z]/.test(form.password)) errs.push("Harus ada minimal 1 huruf besar")
  if (!/[a-z]/.test(form.password)) errs.push("Harus ada minimal 1 huruf kecil")
  if (!/[!@#$%^&*(),.?":{}|<>]/.test(form.password)) errs.push("Harus ada minimal 1 karakter khusus")
  return errs
})
