/**
 * GET /api/tunjangan/transport/:id
 * Mendapatkan detail penerima tunjangan transport pada bulan tertentu.
 * Param: id = "{tahun}-{bulan}" (contoh: "2026-06")
 * Auth: JWT (required) — hanya user dengan akses `modul_tunjangan_transport`.
 * Response: { success, data: { bulan, tahun, bulan_num, penerima: [{ id, nama, km, hari_kerja, nominal }] } }
 */
